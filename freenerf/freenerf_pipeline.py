...
get_eval_loss_dict(self, step: int)
di solito è usata quella standard
"""
...
@dataclass
class TemplatePipelineConfig(VanillaPipelineConfig): # TODO: modificare con custom
...
class TemplatePipeline(VanillaPipeline): # TODO: modificare con custom
    """Template Pipeline
